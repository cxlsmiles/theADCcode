...
inline double Second_order_cap_triplet::V1212(unsigned a, unsigned b, unsigned c, unsigned d)
{
  return V1122(a,c,b,d);
}


Second_order_cap_triplet::Second_order_cap_triplet(SCF_data_reader& phis, Integral_table& tab,Triangular_matrix<double>* mat) 
  : phis_(phis), gs_expt_value2_(0.), d(mat->rows()),  ADC2_DIP_blocks(phis,tab)
{
  ...
  *rho = 0.;
  ...
  for(unsigned i = 0; i < phis_.number_occupied();  i++) 
    rho->operator()(i,i) -= 1; // subtract the 0th order
  ...
  cout << "this is triplet 2nd order\n";
  

}


inline double Second_order_cap_triplet::d2_1(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_2(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_3(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_4(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_5(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_6(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_7(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_8(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_9(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_10(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_11(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_12(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_13(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_14(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d2_15(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::d_ij_i1j1(unsigned i, unsigned j, unsigned i1, unsigned j1)
{
...
inline double Second_order_cap_triplet::vir_sum_rho_d(unsigned i, unsigned i1)
{
...
bool Second_order_cap_triplet::block_ii_jj(const Config &row, const Config &col, double &element)
{
...
bool Second_order_cap_triplet::block_ij_kk(const Config &row, const Config &col, double &element)
{
  return false;
}

bool Second_order_cap_triplet::block_ij_kl(const Config &row, const Config &col, double &element)
{
