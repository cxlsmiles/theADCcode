#ifndef __SECOND_ORDER_TRIPLET_HPP__
#define __SECOND_ORDER_TRIPLET_HPP__
...
class Second_order_cap_triplet:  public ADC2_DIP_blocks {
...
public:
  ...
  Second_order_cap_triplet(SCF_data_reader& phis, Integral_table& tab, Triangular_matrix<double>* mat);
...
#endif //#ifndef __SECOND_ORDER_TRIPLET_HPP__
