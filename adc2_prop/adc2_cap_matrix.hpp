#ifndef __ADC2_CAP_MATRIX_HPP__
#define __ADC2_CAP_MATRIX_HPP__
...
class Adc2_CAP_matrix: public ADC_matrix {
  
  SCF_data_reader& phis_;                    // provides the scf data

  ADC2_DIP_blocks* zero_;          
  ADC2_DIP_blocks* fir_;          
  ADC2_DIP_blocks* sec_; 
...
public:
  ...
  Adc2_CAP_matrix(SCF_data_reader& phis, Integral_table& tab, Triangular_matrix<double>* mat, unsigned int sym, unsigned int spin);
  ~Adc2_CAP_matrix();
...
#endif //#ifndef __ADC2_CAP_MATRIX_HPP__
