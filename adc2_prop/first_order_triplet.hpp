#ifndef __FIRST_ORDER_TRIPLET_HPP__
#define __FIRST_ORDER_TRIPLET_HPP__
...
class First_order_cap_triplet:  public ADC2_DIP_blocks {
...
public:
  ...
  First_order_cap_triplet(SCF_data_reader& phis, Integral_table& tab,  Triangular_matrix<double>* mat);
...
#endif //#ifndef __FIRST_ORDER_TRIPLET_HPP__
